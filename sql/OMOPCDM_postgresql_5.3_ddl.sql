...
CREATE TABLE IF NOT EXISTS @cdmDatabaseSchema.PERSON (
			...
			origin_source_data_provider varchar(255) NULL,
			origin_source_name varchar(255) NULL,
			origin_source_value varchar(255) NULL
			);
...
CREATE TABLE IF NOT EXISTS @cdmDatabaseSchema.VISIT_OCCURRENCE2 (
...
CREATE TABLE IF NOT EXISTS @cdmDatabaseSchema.DEVICE_EXPOSURE (
			device_exposure_id serial NOT NULL,
			person_id integer NOT NULL,
...
VALUES('IACS', 'IACS', 'IACS', 'Clinical Data', 'IACS', 'IACS', null, null, '5.3', '5.3');
